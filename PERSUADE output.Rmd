...
evalq({
  ...
  legend("bottomleft", legend = rep(misc$group_names, 2), 
         col = c(rep("1", length(misc$group_names)), c("black", "lightgrey", "darkgrey")[1:length(misc$group_names)]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:length(misc$group_names)]), rep(1, length(misc$group_names))), 
         cex = 0.8, ncol = 2)
  ...
  legend("topleft", legend = rep(misc$group_names, 2), 
         col =  c(rep("1", length(misc$group_names)), c("black", "lightgrey", "darkgrey")[1:length(misc$group_names)]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:length(misc$group_names)]), rep(NA, length(misc$group_names))),
         pch = c(rep(NA, length(misc$group_names)), c(1, 8, 9)[1:length(misc$group_names)]),
         cex = 0.8, ncol = 2)
...
evalq({
  ...
  legend("bottomleft", legend = rep(misc$group_names, 2), 
         col = c(rep("2", length(misc$group_names)), c("black", "lightgrey", "darkgrey")[1:length(misc$group_names)]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:length(misc$group_names)]), rep(1, length(misc$group_names))), 
         cex = 0.8, ncol = 2)
...
evalq({
  ...
  legend("bottomleft", legend = rep(misc$group_names, 2), 
         col = c(rep("3", length(misc$group_names)), c("black", "lightgrey", "darkgrey")[1:length(misc$group_names)]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:length(misc$group_names)]), rep(1, length(misc$group_names))), 
         cex = 0.8, ncol = 2)
...
evalq({
  ...
  legend("bottomleft", legend = rep(misc$group_names, 2), 
         col = c(rep("4", length(misc$group_names)), c("black", "lightgrey", "darkgrey")[1:length(misc$group_names)]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:length(misc$group_names)]), rep(1, length(misc$group_names))), 
         cex = 0.8, ncol = 2)
...
evalq({
  ...
  legend("bottomleft", legend = rep(misc$group_names, 2), 
         col = c(rep("5", length(misc$group_names)), c("black", "lightgrey", "darkgrey")[1:length(misc$group_names)]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:length(misc$group_names)]), rep(1, length(misc$group_names))), 
         cex = 0.8, ncol = 2)
...
evalq({
  ...
  legend("bottomleft", legend = rep(misc$group_names, 2), 
         col = c(rep("6", length(misc$group_names)), c("black", "lightgrey", "darkgrey")[1:length(misc$group_names)]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:length(misc$group_names)]), rep(1, length(misc$group_names))), 
         cex = 0.8, ncol = 2)
...
evalq({
  ...
  legend("bottomleft", legend = rep(misc$group_names, 2), 
         col = c(rep("7", length(misc$group_names)), c("black", "lightgrey", "darkgrey")[1:length(misc$group_names)]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:length(misc$group_names)]), rep(1, length(misc$group_names))), 
         cex = 0.8, ncol = 2)
...
evalq({
  ...
  legend("bottomleft", legend = rep(misc$group_names, 2), 
         col = c(rep("8", length(misc$group_names)), c("black", "lightgrey", "darkgrey")[1:length(misc$group_names)]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:length(misc$group_names)]), rep(1, length(misc$group_names))), 
         cex = 0.8, ncol = 2)
...
evalq({
  ...
  legend("bottomleft", legend = rep(misc$group_names, 2), 
         col = c(rep("9", length(misc$group_names)), c("black", "lightgrey", "darkgrey")[1:length(misc$group_names)]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:length(misc$group_names)]), rep(1, length(misc$group_names))), 
         cex = 0.8, ncol = 2)
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Weibull non-mixture cure)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$cure_weib_nmix[, 2]), col = "1", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_nmix[, 3]), col = "1", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_nmix[, 4]), col = "1", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
          c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])), 
  ...
  plot(cbind(surv_obs$tp$gr_1$time, surv_obs$tp$gr_1$smooth), lwd = 1, 
       ...
       xlab = "time", ylab = "annual transition probability (smoothed)", 
       ylim = c(0, ceiling(surv_obs$tp$max * 10)/10), xlim = c(0, ceiling(surv_obs$km$maxtime * 10)/10))
  lines(cbind(input$time_pred[-1], surv_pred$tp_gr$gr_1[, 19]), col = "1", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(surv_obs$tp$gr_2$time, surv_obs$tp$gr_2$smooth), 
          col = "lightgrey", type = "b", lwd = 1, cex = 0.6, pch = 8)
    lines(cbind(input$time_pred[-1], surv_pred$tp_gr$gr_2[, 19]), col = "1", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(surv_obs$tp$gr_3$time, surv_obs$tp$gr_3$smooth), 
          col = "darkgrey", type = "b", lwd = 1, cex = 0.6, pch = 9)
    lines(cbind(input$time_pred[-1], surv_pred$tp_gr$gr_3[, 19]), col = "1", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(c(surv_obs$tp$gr_1$time, rev(surv_obs$tp$gr_1$time)), 
          c(surv_obs$tp$gr_1$smooth_lower, rev(surv_obs$tp$gr_1$smooth_upper)), 
