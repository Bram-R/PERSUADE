...
7 | Generalised Gamma | arc-shaped, bathtub-shaped, monotonically increasing or monotonically decreasing hazards
...
evalq({
  ...
  kable_styling(kable(surv_model$param_ic[order(surv_model$param_ic$AIC), ], format = "latex", 
...
evalq({
  ...
  lines(cbind(input$time_pred, surv_pred$model$expo$surv[, 2]), col = "1", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$expo$surv[, 3]), col = "1", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$expo$surv[, 4]), col = "1", lty = "5212", lwd = 2)
  }
  ...
  lines(cbind(input$time_pred, -log(surv_pred$model$expo$surv[, 2])), col = "1", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, -log(surv_pred$model$expo$surv[, 3])), col = "1", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, -log(surv_pred$model$expo$surv[, 4])), col = "1", lty = "5212", lwd = 2)
  }
  legend("topleft", legend = c(misc$group_names, rep("", length(misc$group_names))), 
         col =  c(rep("1", misc$ngroups), c("black", "lightgrey", "darkgrey")[1:misc$ngroups]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:misc$ngroups]), rep(NA, misc$ngroups)),
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Weibull)", xlab = "time", 
       ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$weib$surv[, 2]), col = "2", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$weib$surv[, 3]), col = "2", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$weib$surv[, 4]), col = "2", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  lines(cbind(log(input$time_pred), log(-log(surv_pred$model$weib$surv[, 2]))), col = "2", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$weib$surv[, 3]))), col = "2", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$weib$surv[, 4]))), col = "2", lty = "5212", lwd = 2)
  }
  legend("topleft", legend = c(misc$group_names, rep("", length(misc$group_names))), 
         col =  c(rep("2", misc$ngroups), c("black", "lightgrey", "darkgrey")[1:misc$ngroups]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:misc$ngroups]), rep(NA, misc$ngroups)),
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Gompertz)", xlab = "time", 
       ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$gom$surv[, 2]), col = "3", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$gom$surv[, 3]), col = "3", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$gom$surv[, 4]), col = "3", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Log-normal)", xlab = "time", 
       ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$lnorm$surv[, 2]), col = "4", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$lnorm$surv[, 3]), col = "4", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$lnorm$surv[, 4]), col = "4", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  lines(cbind(log(input$time_pred), 
              -qnorm(surv_pred$model$lnorm$surv[, 2], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)), 
        col = "4", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$lnorm$surv[, 3], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)),
          col = "4", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$lnorm$surv[, 4], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)), 
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Log-logistic)", xlab = "time", 
       ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$llog$surv[, 2]), col = "5", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$llog$surv[, 3]), col = "5", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$llog$surv[, 4]), col = "5", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  lines(cbind(log(input$time_pred), 
              -log(surv_pred$model$llog$surv[, 2]/(1 - surv_pred$model$llog$surv[, 2]))),
        col = "5", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$llog$surv[, 3]/(1 - surv_pred$model$llog$surv[, 3]))), 
          col = "5", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$llog$surv[, 4]/(1 - surv_pred$model$llog$surv[, 4]))),
...
evalq({
  ...
  lines(cbind(input$time_pred, surv_pred$model$gam$surv[, 2]), col = "6", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$gam$surv[, 3]), col = "6", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$gam$surv[, 4]), col = "6", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])), 
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  lines(cbind(log(input$time_pred), log(-log(surv_pred$model$gam$surv[, 2]))), col = "6", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$gam$surv[, 3]))), col = "6", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$gam$surv[, 4]))), col = "6", lty = "5212", lwd = 2)
  }
  legend("topleft", legend = c(misc$group_names, rep("", length(misc$group_names))), 
         col =  c(rep("6", misc$ngroups), c("black", "lightgrey", "darkgrey")[1:misc$ngroups]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:misc$ngroups]), rep(NA, misc$ngroups)),
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Generalised gamma)", xlab = "time", 
       ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$ggam$surv[, 2]), col = "7", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$ggam$surv[, 3]), col = "7", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$ggam$surv[, 4]), col = "7", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), log(-log(surv_obs$km$surv))), cex = 0.6, 
       ...
       xlab = "LN(time)", ylab = "LN(cumulative hazard)")
  lines(cbind(log(input$time_pred), log(-log(surv_pred$model$ggam$surv[, 2]))), col = "7", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$ggam$surv[, 3]))), col = "7", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$ggam$surv[, 4]))), col = "7", lty = "5212", lwd = 2)
  }
  legend("topleft", legend = c(misc$group_names, rep("", length(misc$group_names))), 
         col =  c(rep("7", misc$ngroups), c("black", "lightgrey", "darkgrey")[1:misc$ngroups]), 
         lty = c(as.integer(c(1, "2222", "5212")[1:misc$ngroups]), rep(NA, misc$ngroups)),
...
evalq({
  ...
  kable_styling(kable(rbind(surv_model$param_ic, 
                            surv_model$spline_ic)[order(rbind(surv_model$param_ic, surv_model$spline_ic)$AIC), ], 
...
evalq({
  ...
  lines(cbind(input$time_pred, surv_pred$model$spl_hazard1$surv[, 2]), col = "1", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard1$surv[, 3]), col = "1", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard1$surv[, 4]), col = "1", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), log(-log(surv_obs$km$surv))), cex = 0.6, 
       ...
       xlab = "LN(time)", ylab = "LN(cumulative hazard)")
  lines(cbind(log(input$time_pred), log(-log(surv_pred$model$spl_hazard1$surv[, 2]))), 
        col = "1", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$spl_hazard1$surv[, 3]))), 
          col = "1", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$spl_hazard1$surv[, 4]))), 
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Spline, 2 knots, hazard scale)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$spl_hazard2$surv[, 2]), col = "2", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard2$surv[, 3]), col = "2", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard2$surv[, 4]), col = "2", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), log(-log(surv_obs$km$surv))), cex = 0.6, 
       ...
       xlab = "LN(time)", ylab = "LN(cumulative hazard)")
  lines(cbind(log(input$time_pred), log(-log(surv_pred$model$spl_hazard2$surv[, 2]))), 
        col = "2", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$spl_hazard2$surv[, 3]))), 
          col = "2", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$spl_hazard2$surv[, 4]))), 
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Spline, 3 knots, hazard scale)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$spl_hazard3$surv[, 2]), col = "3", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard3$surv[, 3]), col = "3", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard3$surv[, 4]), col = "3", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), log(-log(surv_obs$km$surv))), cex = 0.6, 
       ...
       xlab = "LN(time)", ylab = "LN(cumulative hazard)")
  lines(cbind(log(input$time_pred), log(-log(surv_pred$model$spl_hazard3$surv[, 2]))), 
        col = "3", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$spl_hazard3$surv[, 3]))), 
          col = "3", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$spl_hazard3$surv[, 4]))), 
          col = "3", lty = "5212", lwd = 2)
  }
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Spline, 1 knot, odds scale)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$spl_odds1$surv[, 2]), col = "4", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$spl_odds1$surv[, 3]), col = "4", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$spl_odds1$surv[, 4]), col = "4", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), -log(surv_obs$km$surv/(1 - surv_obs$km$surv))), 
       ...
       xlab = "LN(time)", ylab = "-LN(survival odds)")
  lines(cbind(log(input$time_pred), 
              -log(surv_pred$model$spl_odds1$surv[, 2]/(1 - surv_pred$model$spl_odds1$surv[, 2]))), 
        col = "4", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$spl_odds1$surv[, 3]/(1 - surv_pred$model$spl_odds1$surv[, 3]))),
          col = "4", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$spl_odds1$surv[, 4]/(1 - surv_pred$model$spl_odds1$surv[, 4]))), 
          col = "4", lty = "5212", lwd = 2)
  }
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Spline, 2 knots, odds scale)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$spl_odds2$surv[, 2]), col = "5", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$spl_odds2$surv[, 3]), col = "5", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$spl_odds2$surv[, 4]), col = "5", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), -log(surv_obs$km$surv/(1 - surv_obs$km$surv))), 
       ...
       xlab = "LN(time)", ylab = "-LN(survival odds)")
  lines(cbind(log(input$time_pred), 
              -log(surv_pred$model$spl_odds2$surv[, 2]/(1 - surv_pred$model$spl_odds2$surv[, 2]))), 
        col = "5", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$spl_odds2$surv[, 3]/(1 - surv_pred$model$spl_odds2$surv[, 3]))), 
          col = "5", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$spl_odds2$surv[, 4]/(1 - surv_pred$model$spl_odds2$surv[, 4]))), 
          col = "5", lty = "5212", lwd = 2)
  }
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Spline, 3 knots, odds scale)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$spl_odds3$surv[, 2]), col = "6", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$spl_odds3$surv[, 3]), col = "6", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$spl_odds3$surv[, 4]), col = "6", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), -log(surv_obs$km$surv/(1 - surv_obs$km$surv))), 
       ...
       xlab = "LN(time)", ylab = "-LN(survival odds)")
  lines(cbind(log(input$time_pred), 
              -log(surv_pred$model$spl_odds3$surv[, 2]/(1 - surv_pred$model$spl_odds3$surv[, 2]))), 
        col = "6", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$spl_odds3$surv[, 3]/(1 - surv_pred$model$spl_odds3$surv[, 3]))), 
          col = "6", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$spl_odds3$surv[, 4]/(1 - surv_pred$model$spl_odds3$surv[, 4]))), 
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Spline, 1 knot, normal scale)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$spl_normal1$surv[, 2]), col = "7", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$spl_normal1$surv[, 3]), col = "7", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$spl_normal1$surv[, 4]), col = "7", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  lines(cbind(log(input$time_pred), 
              -qnorm(surv_pred$model$spl_normal1$surv[, 2], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)), 
        col = "7", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$spl_normal1$surv[, 3], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)),
          col = "7", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$spl_normal1$surv[, 4], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)),
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Spline, 2 knots, normal scale)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$spl_normal2$surv[, 2]), col = "8", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$spl_normal2$surv[, 3]), col = "8", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$spl_normal2$surv[, 4]), col = "8", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  lines(cbind(log(input$time_pred), 
              -qnorm(surv_pred$model$spl_normal2$surv[, 2], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)), 
        col = "8", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$spl_normal2$surv[, 3], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)),
          col = "8", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$spl_normal2$surv[, 4], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)),
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Spline, 3 knots, normal scale)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$spl_normal3$surv[, 2]), col = "9", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$spl_normal3$surv[, 3]), col = "9", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$spl_normal3$surv[, 4]), col = "9", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), 
       ...
       xlab = "LN(time)", ylab = "- standard normal quartiles")
  lines(cbind(log(input$time_pred), 
              -qnorm(surv_pred$model$spl_normal3$surv[, 2], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)), 
        col = "9", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$spl_normal3$surv[, 3], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)),
          col = "9", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$spl_normal3$surv[, 4], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)),
...
evalq({
  ...
  kable_styling(kable(rbind(surv_model$param_ic[,1:2], surv_model$cure_ic[,1:2])[order(rbind(surv_model$param_ic[,1:2],
                                                                                       surv_model$cure_ic[,1:2])$AIC), ], 
                      format = "latex", row.names = FALSE, booktabs = TRUE, 
                      linesep = ""), latex_options = "striped")
}, envir = PERSUADE)

evalq({
  kable_styling(kable(surv_model$cure_ic[,-2], 
                      format = "latex", row.names = FALSE, booktabs = TRUE, 
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Weibull mixture cure)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$cure_weib_mix$surv[, 2]), col = "1", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_mix$surv[, 3]), col = "1", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_mix$surv[, 4]), col = "1", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), log(-log(surv_obs$km$surv))), cex = 0.6, 
       ...
       xlab = "LN(time)", ylab = "LN(cumulative hazard)")
  lines(cbind(log(input$time_pred), log(-log(surv_pred$model$cure_weib_mix$surv[, 2]))), 
        col = "1", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$cure_weib_mix$surv[, 3]))), 
          col = "1", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$cure_weib_mix$surv[, 4]))), 
          col = "1", lty = "5212", lwd = 2)
  }
  legend("topleft", legend = c(misc$group_names, rep("", length(misc$group_names))), 
         col =  c(rep("1", misc$ngroups), c("black", "lightgrey", "darkgrey")[1:misc$ngroups]), 
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Weibull non-mixture cure)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$cure_weib_nmix$surv[, 2]), col = "2", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_nmix$surv[, 3]), col = "2", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_nmix$surv[, 4]), col = "2", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), log(-log(surv_obs$km$surv))), cex = 0.6, 
       ...
       xlab = "LN(time)", ylab = "LN(cumulative hazard)")
  lines(cbind(log(input$time_pred), log(-log(surv_pred$model$cure_weib_nmix$surv[, 2]))), 
        col = "2", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$cure_weib_nmix$surv[, 3]))), 
          col = "2", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), log(-log(surv_pred$model$cure_weib_nmix$surv[, 4]))), 
          col = "2", lty = "5212", lwd = 2)
  }
  legend("topleft", legend = c(misc$group_names, rep("", length(misc$group_names))), 
         col =  c(rep("1", misc$ngroups), c("black", "lightgrey", "darkgrey")[1:misc$ngroups]), 
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Log-normal mixture cure)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_mix$surv[, 2]), col = "3", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_mix$surv[, 3]), col = "3", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_mix$surv[, 4]), col = "3", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), 
       ...
       ylab = "- standard normal quartiles")
  lines(cbind(log(input$time_pred), 
              -qnorm(surv_pred$model$cure_lnorm_mix$surv[, 2], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)), 
        col = "3", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$cure_lnorm_mix$surv[, 3], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)),
          col = "3", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$cure_lnorm_mix$surv[, 4], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)), 
          col = "3", lty = "5212", lwd = 2)
  }
  legend("topleft", legend = c(misc$group_names, rep("", length(misc$group_names))), 
         col =  c(rep("4", misc$ngroups), c("black", "lightgrey", "darkgrey")[1:misc$ngroups]), 
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Log-normal non-mixture cure)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_nmix$surv[, 2]), col = "4", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_nmix$surv[, 3]), col = "4", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_nmix$surv[, 4]), col = "4", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  plot(cbind(log(surv_obs$km$time), 
       ...
       ylab = "- standard normal quartiles")
  lines(cbind(log(input$time_pred), 
              -qnorm(surv_pred$model$cure_lnorm_nmix$surv[, 2], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)), 
        col = "4", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$cure_lnorm_nmix$surv[, 3], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)),
          col = "4", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -qnorm(surv_pred$model$cure_lnorm_nmix$surv[, 4], mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)), 
          col = "4", lty = "5212", lwd = 2)
  }
  legend("topleft", legend = c(misc$group_names, rep("", length(misc$group_names))), 
         col =  c(rep("4", misc$ngroups), c("black", "lightgrey", "darkgrey")[1:misc$ngroups]), 
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Log-logistic mixture cure)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$cure_llog_mix$surv[, 2]), col = "5", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$cure_llog_mix$surv[, 3]), col = "5", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$cure_llog_mix$surv[, 4]), col = "5", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  lines(cbind(log(input$time_pred), 
              -log(surv_pred$model$cure_llog_mix$surv[, 2]/(1 - surv_pred$model$cure_llog_mix$surv[, 2]))),
        col = "5", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$cure_llog_mix$surv[, 3]/(1 - surv_pred$model$cure_llog_mix$surv[, 3]))), 
          col = "5", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$cure_llog_mix$surv[, 4]/(1 - surv_pred$model$cure_llog_mix$surv[, 4]))),
          col = "5", lty = "5212", lwd = 2)
  }
  legend("topleft", legend = c(misc$group_names, rep("", length(misc$group_names))), 
         col =  c(rep("5", misc$ngroups), c("black", "lightgrey", "darkgrey")[1:misc$ngroups]), 
...
evalq({
  ...
  plot(surv_obs$km, lwd = 2, main = "A: Kaplan-Meier (Log-logistic non-mixture cure)", 
       xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))
  lines(cbind(input$time_pred, surv_pred$model$cure_llog_nmix$surv[, 2]), col = "6", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(input$time_pred, surv_pred$model$cure_llog_nmix$surv[, 3]), col = "6", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(input$time_pred, surv_pred$model$cure_llog_nmix$surv[, 4]), col = "6", lty = "5212", lwd = 2)
  }
  # add shading confidence intervals
  polygon(na.omit(data.frame(c(surv_obs$km$time[surv_obs$km_names == 1], rev(surv_obs$km$time[surv_obs$km_names == 1])),
                             c(surv_obs$km$lower[surv_obs$km_names == 1], rev(surv_obs$km$upper[surv_obs$km_names == 1])))), 
  ...
  lines(cbind(log(input$time_pred), 
              -log(surv_pred$model$cure_llog_nmix$surv[, 2]/(1 - surv_pred$model$cure_llog_nmix$surv[, 2]))),
        col = "6", lty = 1, lwd = 2)
  if (misc$ngroups > 1) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$cure_llog_nmix$surv[, 3]/(1 - surv_pred$model$cure_llog_nmix$surv[, 3]))), 
          col = "6", lty = "2222", lwd = 2)
  }
  if (misc$ngroups > 2) {
    lines(cbind(log(input$time_pred), 
                -log(surv_pred$model$cure_llog_nmix$surv[, 4]/(1 - surv_pred$model$cure_llog_nmix$surv[, 4]))),
          col = "6", lty = "5212", lwd = 2)
  }
  legend("topleft", legend = c(misc$group_names, rep("", length(misc$group_names))), 
         col =  c(rep("5", misc$ngroups), c("black", "lightgrey", "darkgrey")[1:misc$ngroups]), 
...
evalq({
  ...
  lines(cbind(input$time_pred, surv_pred$model$expo$surv[, 2]), col = "1", lty = 1, lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$weib$surv[, 2]), col = "2", lty = 1, lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$gom$surv[, 2]), col = "3", lty = 1, lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$lnorm$surv[, 2]), col = "4", lty = 1, lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$llog$surv[, 2]), col = "5", lty = 1, lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$gam$surv[, 2]), col = "6", lty = 1, lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$ggam$surv[, 2]), col = "7", lty = 1, lwd = 1)
  ...
  if (input$spline_mod == TRUE) {
    plot(surv_obs$km[1], lwd = 2, col = "black", main = "B: Kaplan-Meier (spline curves)", 
         xlab = "time", ylab = "survival", xlim = c(0, input$time_horizon))
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard1$surv[, 2]), col = "1", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard2$surv[, 2]), col = "2", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard3$surv[, 2]), col = "3", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_odds1$surv[, 2]), col = "4", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_odds2$surv[, 2]), col = "5", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_odds3$surv[, 2]), col = "6", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_normal1$surv[, 2]), col = "7", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_normal2$surv[, 2]), col = "8", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_normal3$surv[, 2]), col = "9", lty = 1, lwd = 1)
  ...
  if (input$cure_mod == TRUE) {
    plot(surv_obs$km[1], lwd = 2, col = "black", main = "C: Kaplan-Meier (cure curves)", 
         xlab = "time", ylab = "survival", xlim = c(0, input$time_horizon))
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_mix$surv[, 2]), col = "1", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_nmix$surv[, 2]), col = "2", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_mix$surv[, 2]), col = "3", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_nmix$surv[, 2]), col = "4", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_llog_mix$surv[, 2]), col = "5", lty = 1, lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_llog_nmix$surv[, 2]), col = "6", lty = 1, lwd = 1)
...
evalq({
  ...
  plot(surv_obs$km[2], lwd = 2, col = "black", main = "A: Kaplan-Meier (parametric curves)", 
       xlab = "time", ylab = "survival", xlim = c(0, input$time_horizon))
  lines(cbind(input$time_pred, surv_pred$model$expo$surv[, 3]), col = "1", lty = "2222", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$weib$surv[, 3]), col = "2", lty = "2222", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$gom$surv[, 3]), col = "3", lty = "2222", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$lnorm$surv[, 3]), col = "4", lty = "2222", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$llog$surv[, 3]), col = "5", lty = "2222", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$gam$surv[, 3]), col = "6", lty = "2222", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$ggam$surv[, 3]), col = "7", lty = "2222", lwd = 1)
  ...
  if (input$spline_mod == TRUE) {
    plot(surv_obs$km[2], lwd = 2, col = "black", main = "B: Kaplan-Meier (spline curves)", 
         xlab = "time", ylab = "survival", xlim = c(0, input$time_horizon))
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard1$surv[, 3]), col = "1", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard2$surv[, 3]), col = "2", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard3$surv[, 3]), col = "3", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_odds1$surv[, 3]), col = "4", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_odds2$surv[, 3]), col = "5", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_odds3$surv[, 3]), col = "6", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_normal1$surv[, 3]), col = "7", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_normal2$surv[, 3]), col = "8", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_normal3$surv[, 3]), col = "9", lty = "2222", lwd = 1)
  ...
  if (input$cure_mod == TRUE) {
    plot(surv_obs$km[2], lwd = 2, col = "black", main = "C: Kaplan-Meier (cure curves)", 
         xlab = "time", ylab = "survival", xlim = c(0, input$time_horizon))
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_mix$surv[, 3]), col = "1", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_nmix$surv[, 3]), col = "2", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_mix$surv[, 3]), col = "3", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_nmix$surv[, 3]), col = "4", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_llog_mix[, 3]), col = "5", lty = "2222", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_llog_nmix$surv[, 3]), col = "6", lty = "2222", lwd = 1)
...
evalq({
  ...
  plot(surv_obs$km[3], lwd = 2, col = "black", main = "A: Kaplan-Meier (parametric curves)", 
       xlab = "time", ylab = "survival", xlim = c(0, input$time_horizon))
  lines(cbind(input$time_pred, surv_pred$model$expo$surv[, 4]), col = "1", lty = "5212", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$weib$surv[, 4]), col = "2", lty = "5212", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$gom$surv[, 4]), col = "3", lty = "5212", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$lnorm$surv[, 4]), col = "4", lty = "5212", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$llog$surv[, 4]), col = "5", lty = "5212", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$gam$surv[, 4]), col = "6", lty = "5212", lwd = 1)
  lines(cbind(input$time_pred, surv_pred$model$ggam$surv[, 4]), col = "7", lty = "5212", lwd = 1)
  ...
  if (input$spline_mod == TRUE) {
    plot(surv_obs$km[3], lwd = 2, col = "black", main = "B: Kaplan-Meier (spline curves)", 
         xlab = "time", ylab = "survival", xlim = c(0, input$time_horizon))
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard1$surv[, 4]), col = "1", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard2$surv[, 4]), col = "2", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_hazard3$surv[, 4]), col = "3", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_odds1$surv[, 4]), col = "4", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_odds2$surv[, 4]), col = "5", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_odds3$surv[, 4]), col = "6", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_normal1$surv[, 4]), col = "7", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_normal2$surv[, 4]), col = "8", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$spl_normal3$surv[, 4]), col = "9", lty = "5212", lwd = 1)
  ...
  if (input$cure_mod == TRUE) {
    plot(surv_obs$km[3], lwd = 2, col = "black", main = "C: Kaplan-Meier (cure curves)", 
         xlab = "time", ylab = "survival", xlim = c(0, input$time_horizon))
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_mix$surv[, 4]), col = "1", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_weib_nmix$surv[, 4]), col = "2", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_mix$surv[, 4]), col = "3", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_lnorm_nmix$surv[, 4]), col = "4", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_llog_mix$surv[, 4]), col = "5", lty = "5212", lwd = 1)
    lines(cbind(input$time_pred, surv_pred$model$cure_llog_nmix$surv[, 4]), col = "6", lty = "5212", lwd = 1)
