...
packages <- c("rms", "survival", "flexsurv", "muhaz", "survminer", "ggplot2", "data.table", "printr")
...
#survival over time (years)
round(extrapolation_gr_1[1 + time_pred_surv_table,], 3)[,1:8]
if (show_spline == TRUE){
round(extrapolation_gr_1[1 + time_pred_surv_table,], 3)[,c(1,9:12)]
round(extrapolation_gr_1[1 + time_pred_surv_table,], 3)[,c(1,13:14)]
}
#annual transition probabilities
print(summary(round(tp_gr_1[,2:cols_extr], 4)))
...
#survival over time (years)
round(extrapolation_gr_2[1 + time_pred_surv_table,], 3)[,1:8]
if (show_spline == TRUE){
round(extrapolation_gr_2[1 + time_pred_surv_table,], 3)[,c(1,9:12)]
round(extrapolation_gr_2[1 + time_pred_surv_table,], 3)[,c(1,13:14)]
}
#annual transition probabilities
print(summary(round(tp_gr_2[,2:cols_extr], 4)))
...
#survival over time (years)
round(extrapolation_gr_3[1 + time_pred_surv_table,], 3)[,1:8]
if (show_spline == TRUE){
round(extrapolation_gr_3[1 + time_pred_surv_table,], 3)[,c(1,9:12)]
round(extrapolation_gr_3[1 + time_pred_surv_table,], 3)[,c(1,13:14)]
}
#annual transition probabilities
print(summary(round(tp_gr_3[,2:cols_extr], 4)))
