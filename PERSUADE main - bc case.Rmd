...
```{r PH_assumption, echo=FALSE, eval=if (ngroups>1) {TRUE} else {FALSE}, out.height = "30%"}
...
##Exponential
```{r expo, echo=FALSE, out.height = "30%"}
#constant hazard
...
##Weibull
```{r weib, echo=FALSE, out.height = "30%"}
...
##Gompertz
```{r gom, echo=FALSE, out.height = "30%"}
#monotonically increasing or decreasing hazard 
...
##Lognormal
```{r lnorm, echo=FALSE, out.height = "30%"}
...
##Loglogistic
```{r llog, echo=FALSE, out.height = "30%"}
#hazard can be non-monotonic with respect to time; initially an increasing hazard, followed by a decreasing hazard
...
##Gamma
```{r gam, echo=FALSE, out.height = "30%"}
...
##Generalised Gamma 
```{r ggam, echo=FALSE, out.height = "30%"}
...
```{r spline_hazard1, echo=FALSE, out.height = "30%", eval = show_spline}
#1 knot
...
```{r spline_hazard2, echo=FALSE, out.height = "30%", eval = show_spline}
#2 knots
...
##Spline odds 1 knot
```{r spline_odds1, echo=FALSE, out.height = "30%", eval = show_spline}
#1 knot
...
##Spline odds 2 knots
```{r spline_odds2, echo=FALSE, out.height = "30%", eval = show_spline}
#2 knots
...
```{r spline_norm1, echo=FALSE, out.height = "30%", eval = show_spline}
#1 knot
...
```{r spline_norm2, echo=FALSE, out.height = "30%", eval = show_spline}
#2 knots
...
```{r validate_extrapolation1, echo=FALSE, out.height = "29%", comment=NA}
#parametric curves
...
```{r validate_extrapolation2, echo=FALSE, out.height = "28%", eval=if (ngroups>1) {TRUE} else {FALSE}, comment=NA}
#parametric curves
...
```{r validate_extrapolation3, echo=FALSE, out.height = "27%", eval=if (ngroups>2) {TRUE} else {FALSE}, comment=NA}
#parametric curves
