...
```{r validate_extrapolation1, echo=FALSE, out.height = "30%", comment=NA}
#parametric curves
...
```{r validate_extrapolation2, echo=FALSE, out.height = "30%", eval=if (ngroups>1) {TRUE} else {FALSE}, comment=NA}
#parametric curves
...
```{r validate_extrapolation3, echo=FALSE, out.height = "30%", eval=if (ngroups>2) {TRUE} else {FALSE}, comment=NA}
#parametric curves
