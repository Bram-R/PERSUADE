...
PERSUADE <- PERSUADE(years = years, status = status, group = group,
                     strata = TRUE, time_unit= time_unit, time_horizon = time_horizon,
                     time_pred_surv_table = time_pred_surv_table, spline_mod = TRUE,
                     csv_semicolon = FALSE, csv_comma = TRUE, clipboard = FALSE)
rm(group, time_horizon, time_pred_surv_table)#SHOULD BE ADJUSTED
attach(PERSUADE)#SHOULD BE ADJUSTED (potenitally with(PERSUADE, )) OR evalq({}, envir=PERSUADE)
```
...
suppressWarnings(
  if (ngroups>1) {
    ggsurvplot(surv_fit(form, data = data.frame(years, status, group)), linetype=c("strata"),
               ...
               censor = FALSE, ggtheme = theme_light())} else {
                 ggsurvplot(surv_fit(form, data = data.frame(years, status)),  
                            legend.labs = group_names, risk.table = TRUE, conf.int = TRUE,
                            surv.median.line = "hv",  ncensor.plot = FALSE,
...
```{r PH_assumption, echo=FALSE, eval=if (ngroups>1) {TRUE} else {FALSE}, out.height = "29%", fig.width=11}
...
if (ngroups>1) {
  lines(cbind(hr_smooth2$est.grid, hr_smooth2$haz.est), col="green", lty='1234', lwd=2)}
if (ngroups>2) {
  lines(cbind(hr_smooth3$est.grid, hr_smooth3$haz.est), col="blue", lty='9212', lwd=2)}
legend("topleft", legend= group_names, col=c("red", "green", "blue"), 
       lty=as.integer(c(1, '1234', '9212')), cex=0.8)
```
...
pie(rep(1, n), labels =lbls, col = rainbow(n=n, s = 1, v = 1, start = 0, end = max(1, n - 1)/n, 
                                           alpha = 1)) 
kable_styling(kable(IC[order(IC$AIC),], 
                    format = "latex", row.names = FALSE, booktabs = TRUE, linesep = ""), 
...
#constant hazard
plot(km, lwd=2, main ="A: Kaplan-Meier (Exponential)", xlab = "time", 
     ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, expo_pred[,2]), col="1", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, expo_pred[,3]), col="1", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, expo_pred[,4]), col="1", lty='9212', lwd=2)}
...
plot(cbind(time_pred[-1], tp_gr_1[,2]), main ="B: Annual transition probability (Exponential)", 
     ...
     lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,2]), col="1", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,2]), col="1", lty='9212', lwd=2)}
legend("topleft", legend= group_names, col="1",  
       lty=as.integer(c(1, '1234', '9212')), cex=0.8)

#diagnostics
plot(cbind(km$time, -log(km$surv)), cex = 0.6, 
     pch = c(1, 8, 9)[km_names], col = c("black", "lightgrey", "darkgrey")[km_names], 
     main ="C: Diagnostic plot (Exponential)", 
     xlab = "time", ylab = "cumulative hazard")
lines(cbind(time_pred, -log(expo_pred[,2])), col="1", lty=1, lwd=2) 
if (ngroups>1) {lines(cbind(time_pred, -log(expo_pred[,3])), col="1", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, -log(expo_pred[,4])), col="1", lty='9212', lwd=2)}
legend("topleft", legend= group_names, col="1",  
       lty=as.integer(c(1, '1234', '9212')), cex=0.8)
```
...
plot(km, lwd=2, main ="A: Kaplan-Meier (Weibull)", xlab = "time", 
     ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, weib_pred[,2]), col="2", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, weib_pred[,3]), col="2", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, weib_pred[,4]), col="2", lty='9212', lwd=2)}
...
plot(cbind(time_pred[-1], tp_gr_1[,3]), main ="B: Annual transition probability (Weibull)", 
     ...
     lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,3]), col="2", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,3]), col="2", lty='9212', lwd=2)}
legend("topleft", legend= group_names, col="2",  
       lty=as.integer(c(1, '1234', '9212')), cex=0.8)     
#diagnostics 
plot(cbind(log(km$time), log(-log(km$surv))), cex = 0.6, 
     pch = c(1, 8, 9)[km_names], col = c("black", "lightgrey", "darkgrey")[km_names],
...
#monotonically increasing or decreasing hazard 
plot(km, lwd=2, main ="A: Kaplan-Meier (Gompertz)", xlab = "time", 
     ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, gom_pred[,2]), col="3", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, gom_pred[,3]), col="3", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, gom_pred[,4]), col="3", lty='9212', lwd=2)}
...
plot(cbind(time_pred[-1], tp_gr_1[,4]), main ="B: Annual transition probability (Gompertz)", 
     ...
     type="l", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,4]), col="3", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,4]), col="3", lty='9212', lwd=2)}
...
plot(cbind(c(hr_smooth1$est.grid, if (ngroups>1) {hr_smooth2$est.grid} else {NA},
     ...
     cex = 0.6, main ="C: Diagnostic plot (Gompertz)", xlab = "time", 
...
plot(km, lwd=2, main ="A: Kaplan-Meier (Log-normal)", xlab = "time", 
     ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, lnorm_pred[,2]), col="4", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, lnorm_pred[,3]), col="4", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, lnorm_pred[,4]), col="4", lty='9212', lwd=2)}
...
plot(cbind(time_pred[-1], tp_gr_1[,5]), main ="B: Annual transition probability (Log-normal)", 
     ...
     lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,5]), col="4", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,5]), col="4", lty='9212', lwd=2)}
...
#hazard can be non-monotonic with respect to time; initially an increasing hazard, followed by a decreasing hazard
plot(km, lwd=2, main ="A: Kaplan-Meier (Log-logistic)", xlab = "time", 
     ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, llog_pred[,2]), col="5", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, llog_pred[,3]), col="5", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, llog_pred[,4]), col="5", lty='9212', lwd=2)}
...
plot(cbind(time_pred[-1], tp_gr_1[,6]), 
     ...
     type="l", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,6]), col="5", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,6]), col="5", lty='9212', lwd=2)}
legend("topleft", legend= group_names, col="5",  
       lty=as.integer(c(1, '1234', '9212')), cex=0.8) 

#diagnostics
plot(cbind(log(km$time), -log(km$surv/(1-km$surv))), cex = 0.6, 
     pch = c(1, 8, 9)[km_names], col = c("black", "lightgrey", "darkgrey")[km_names],
...
plot(km, lwd=2, main ="A: Kaplan-Meier (Gamma)", xlab = "time", 
     ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, gam_pred[,2]), col="6", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, gam_pred[,3]), col="6", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, gam_pred[,4]), col="6", lty='9212', lwd=2)}
...
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,7]), col="6", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,7]), col="6", lty='9212', lwd=2)}
...
if (ngroups>1) {lines(cbind(time_pred, ggam_pred[,3]), col="7", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, ggam_pred[,4]), col="7", lty='9212', lwd=2)}
...
plot(cbind(time_pred[-1], tp_gr_1[,8]), 
     ...
     lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,8]), col="7", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,8]), col="7", lty='9212', lwd=2)}
...
kable_styling(kable(rbind(IC, IC_spl)[order(rbind(IC, IC_spl)$AIC),], 
                    format = "latex", row.names = FALSE, booktabs = TRUE, linesep = ""), 
              latex_options = "striped")
...
```{r spline_hazard1, echo=FALSE, out.height = "30%", fig.width=11, eval = show_spline}
#1 knot
plot(km, lwd=2, main ="A: Kaplan-Meier (Spline, 1 knot, hazard scale)", 
     xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, spl_hazard1_pred[,2]), col="1", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, spl_hazard1_pred[,3]), col="1", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, spl_hazard1_pred[,4]), col="1", lty='9212', lwd=2)}
...
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,9]), col="1", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,9]), col="1", lty='9212', lwd=2)}
abline(v=exp(spl_hazard1$knots[2]), lty='9212', lwd=1.5)
abline(v=exp(spl_hazard1$knots[1]), lty='9212', lwd=0.5)
abline(v=exp(spl_hazard1$knots[3]), lty='9212', lwd=0.5)
legend("topleft", legend= group_names, col="1",  
...
```{r spline_hazard2, echo=FALSE, out.height = "30%", fig.width=11, eval = show_spline}
#2 knots
plot(km, lwd=2, main ="A: Kaplan-Meier (Spline, 2 knots, hazard scale)", 
     xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, spl_hazard2_pred[,2]), col="2", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, spl_hazard2_pred[,3]), col="2", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, spl_hazard2_pred[,4]), col="2", lty='9212', lwd=2)}
...
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,10]), col="2", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,10]), col="2", lty='9212', lwd=2)}
abline(v=exp(spl_hazard2$knots[2]), lty='9212', lwd=1.5)
abline(v=exp(spl_hazard2$knots[3]), lty='9212', lwd=1.5)
abline(v=exp(spl_hazard2$knots[1]), lty='9212', lwd=0.5)
abline(v=exp(spl_hazard2$knots[4]), lty='9212', lwd=0.5)
...
##Spline odds 1 knot
```{r spline_odds1, echo=FALSE, out.height = "30%", fig.width=11, eval = show_spline}
#1 knot
plot(km, lwd=2, main ="A: Kaplan-Meier (Spline, 1 knot, odds scale)", 
     xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, spl_odds1_pred[,2]), col="3", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, spl_odds1_pred[,3]), col="3", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, spl_odds1_pred[,4]), col="3", lty='9212', lwd=2)}
...
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,11]), col="3", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,11]), col="3", lty='9212', lwd=2)}
abline(v=exp(spl_odds1$knots[2]), lty='9212', lwd=1.5)
abline(v=exp(spl_odds1$knots[1]), lty='9212', lwd=0.5)
abline(v=exp(spl_odds1$knots[3]), lty='9212', lwd=0.5)
legend("topleft", legend= group_names, col="3",  
...
##Spline odds 2 knots
```{r spline_odds2, echo=FALSE, out.height = "30%", fig.width=11, eval = show_spline}
#2 knots
plot(km, lwd=2, main ="A: Kaplan-Meier (Spline, 2 knots, odds scale)", 
     xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, spl_odds2_pred[,2]), col="4", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, spl_odds2_pred[,3]), col="4", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, spl_odds2_pred[,4]), col="4", lty='9212', lwd=2)}
...
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,12]), col="4", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,12]), col="4", lty='9212', lwd=2)}
abline(v=exp(spl_odds2$knots[2]), lty='9212', lwd=1.5)
abline(v=exp(spl_odds2$knots[3]), lty='9212', lwd=1.5)
abline(v=exp(spl_odds2$knots[1]), lty='9212', lwd=0.5)
abline(v=exp(spl_odds2$knots[4]), lty='9212', lwd=0.5)
...
```{r spline_norm1, echo=FALSE, out.height = "30%", fig.width=11, eval = show_spline}
#1 knot
plot(km, lwd=2, main ="A: Kaplan-Meier (Spline, 1 knot, normal scale)", 
     xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, spl_normal1_pred[,2]), col="5", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, spl_normal1_pred[,3]), col="5", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, spl_normal1_pred[,4]), col="5", lty='9212', lwd=2)}
...
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,13]), col="5", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,13]), col="5", lty='9212', lwd=2)}
abline(v=exp(spl_normal1$knots[2]), lty='9212', lwd=1.5)
abline(v=exp(spl_normal1$knots[1]), lty='9212', lwd=0.5)
abline(v=exp(spl_normal1$knots[3]), lty='9212', lwd=0.5)
legend("topleft", legend= group_names, col="5",  
...
plot(cbind(log(km$time), -qnorm(km$surv, mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)),
     pch = c(1, 8, 9)[km_names], col = c("black", "lightgrey", "darkgrey")[km_names],
     cex = 0.6, main ="C: Diagnostic plot (Spline, 1 knot, normal scale)", 
...
if (ngroups>1) {
  lines(cbind(log(time_pred), 
              -qnorm(spl_normal1_pred[,3], mean = 0, sd = 1, lower.tail = TRUE, 
                     log.p = FALSE)), col="5", lty='1234', lwd=2)}
if (ngroups>2) {
  lines(cbind(log(time_pred), 
              -qnorm(spl_normal1_pred[,4], mean = 0, sd = 1, lower.tail = TRUE, 
                     log.p = FALSE)), col="5", lty='9212', lwd=2)}   
...
```{r spline_norm2, echo=FALSE, out.height = "30%", fig.width=11, eval = show_spline}
#2 knots
plot(km, lwd=2, main ="A: Kaplan-Meier (Spline, 2 knots, normal scale)", 
     xlab = "time", ylab = "survival", col = c("black", "lightgrey", "darkgrey"))  
lines(cbind(time_pred, spl_normal2_pred[,2]), col="6", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred, spl_normal2_pred[,3]), col="6", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred, spl_normal2_pred[,4]), col="6", lty='9212', lwd=2)}
...
plot(cbind(time_pred[-1], tp_gr_1[,14]), 
     ...
     ylab = "annual transition probability", ylim=c(0,1), col="6", type="l", lty=1, lwd=2)
if (ngroups>1) {lines(cbind(time_pred[-1], tp_gr_2[,14]), col="6", lty='1234', lwd=2)}
if (ngroups>2) {lines(cbind(time_pred[-1], tp_gr_3[,14]), col="6", lty='9212', lwd=2)}
abline(v=exp(spl_normal2$knots[2]), lty='9212', lwd=1.5)
abline(v=exp(spl_normal2$knots[3]), lty='9212', lwd=1.5)
abline(v=exp(spl_normal2$knots[1]), lty='9212', lwd=0.5)
abline(v=exp(spl_normal2$knots[4]), lty='9212', lwd=0.5)
...
plot(cbind(log(km$time), -qnorm(km$surv, mean = 0, sd = 1, lower.tail = TRUE, log.p = FALSE)),
     pch = c(1, 8, 9)[km_names], col = c("black", "lightgrey", "darkgrey")[km_names],
     cex = 0.6, main ="C: Diagnostic plot (Spline, 2 knots, normal scale)", 
     xlab = "LN(time)", ylab = "- standard normal quartiles")
...
if (ngroups>1) {
  lines(cbind(log(time_pred),
              -qnorm(spl_normal2_pred[,3], mean = 0, sd = 1, lower.tail = TRUE, 
                     log.p = FALSE)), col="6", lty='1234', lwd=2)}
if (ngroups>2) {
  lines(cbind(log(time_pred),
              -qnorm(spl_normal2_pred[,4], mean = 0, sd = 1, lower.tail = TRUE, 
                     log.p = FALSE)), col="6", lty='9212', lwd=2)}   
...
kable_styling(kable(t(round(extrapolation_gr_1[1 + time_pred_surv_table,], 3))[-1,],
...
suppressWarnings(kable_styling(kable(descr(tp_gr_1[,2:cols_extr], 
...
```{r validate_extrapolation2, echo=FALSE, out.height = "29%", fig.width=11, eval=if (ngroups>1) {TRUE} else {FALSE}, comment=NA}
#parametric curves
...
kable_styling(kable(t(round(extrapolation_gr_2[1 + time_pred_surv_table,], 3))[-1,],
...
suppressWarnings(kable_styling(kable(descr(tp_gr_2[,2:cols_extr], 
                                           stats = "fivenum", transpose = TRUE), 
                                     format = "latex", booktabs = TRUE, linesep = ""), 
                               latex_options = "striped", position = "left")
)    
...
```{r validate_extrapolation3, echo=FALSE, out.height = "29%", fig.width=11, eval=if (ngroups>2) {TRUE} else {FALSE}, comment=NA}
#parametric curves
...
kable_styling(kable(t(round(extrapolation_gr_3[1 + time_pred_surv_table,], 3))[-1,],
...
suppressWarnings(kable_styling(kable(descr(tp_gr_3[,2:cols_extr],
                                           stats = "fivenum", transpose = TRUE), 
                                     format = "latex", booktabs = TRUE, linesep = ""), 
                               latex_options = "striped", position = "left")
) 
