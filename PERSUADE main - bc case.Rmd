...
knitr::opts_chunk$set(echo=TRUE, fig.align="left", fig.width=4, fig.height=3)
```
...
suppressWarnings(kable(descr(tp_gr_1[,2:cols_extr], 
...
suppressWarnings(kable(descr(tp_gr_2[,2:cols_extr], 
                             stats = "fivenum", transpose = TRUE)))      
...
suppressWarnings(kable(descr(tp_gr_3[,2:cols_extr],
                             stats = "fivenum", transpose = TRUE)))      
